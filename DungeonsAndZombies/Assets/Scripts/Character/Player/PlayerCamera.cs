    ...
    public class PlayerCamera : MonoBehaviour
    {
        ...
        private void HandleRotations()
        {
            ...
            else
            {
                ...
                //yaw = transform.localEulerAngles.y + PlayerInputManager.instance.cameraHorizontal_Input * leftAndRightRotationSpeed;

                //bool invertCamera = false;

                //if (!invertCamera)
                //{
                //    pitch -= upAndDownRotationSpeed * PlayerInputManager.instance.cameraVertical_Input;
                //}
                //else
                //{
                //    // Inverted Y
                ...
                //pitch = Mathf.Clamp(pitch, -minimumPivot, maximumPivot);

                //transform.localEulerAngles = new Vector3(0, yaw, 0);
                //cameraPivotTransform.transform.localEulerAngles = new Vector3(pitch, 0, 0);
            }
        }
